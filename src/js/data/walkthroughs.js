    ...
    steps: [
      {
        ...
        body: [
          ...
          'Say you hold two hearts and there are two more hearts on the flop. Any further heart completes your flush. A deck holds 13 hearts; you can see four of them, so **nine** are unaccounted for. Nine outs.',
          'That is all counting outs is — how many unseen cards win the hand for you.',
        ],
        check: {
          question: 'You hold two hearts, and two more hearts are on the flop. How many hearts are left in the deck?',
          options: [
            {
              key: 'a',
              label: '9',
              why: 'Right. There are 13 hearts, you can see four of them, so nine are still out there. This is the single most common draw in poker and the number worth knowing cold.',
            },
            {
              key: 'b',
              label: '11',
              why: 'That subtracts only your two hole cards. The two hearts on the flop are visible as well, so four are accounted for: 13 − 4 = 9.',
            },
            {
              key: 'c',
              label: '13',
              why: 'That is how many hearts the deck contains in total, before removing the ones you can already see. Four are on show, leaving nine.',
            },
          ],
          answer: 'a',
        },
      ...
      },
      {
        ...
        body: [
          ...
          'Where does that come from? There are around 47 unseen cards, so each out is worth roughly 2% per card to come — and 2% per card, twice, is 4%.',
          'It drifts a little high when you have a lot of outs (15 outs by the rule of 4 gives 60%, where the truth is nearer 54%), but at the table it is close enough to make correct decisions with.',
        ],
        check: {
